...
Trip.create(title: "Europe!", description: "Traveled Europe!", start_date: "2014-1-1", end_date: "2014-1-1", destinations: ['flushing', 'naz house', "shah's halal", "My house", "Dumbo", "WeWorK"], all_trips: 10, user_id: 1, event_id: 1, location_id: 1)
